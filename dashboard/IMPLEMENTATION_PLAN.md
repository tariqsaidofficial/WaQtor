...
### **المرحلة 2️⃣: إنشاء صفحة Profile**

#### **المطلوب:**
- [ ] إنشاء `/app/(main)/profile/page.tsx`
- [ ] تصميم صفحة Profile احترافية
- [ ] إضافة Avatar مع إمكانية رفع صورة
- [ ] معلومات المستخدم (الاسم، البريد، رقم الهاتف)
- [ ] إعدادات الحساب
- [ ] تاريخ النشاط
...
### **المرحلة 4️⃣: نظام BlockUI للصفحات المحمية**

#### **المطلوب:**
- [ ] تطبيق BlockUI على 3 صفحات:
  - `/campaigns`
  - `/reports`
  - `/interactive`
- [ ] إضافة نافذة InputOtp عند الضغط
- [ ] التحقق من الكود (1234 مؤقتاً)
